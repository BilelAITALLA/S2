public class Essai {
	...
	public static void main(String[] args) throws CompteException{
		...
		antoine.setAdresse("12 rue de Belleville");
		System.out.println(antoine.toString());
		...
		System.out.println(compteAntoine);
		try {
			compteAntoine.débiter(222);
		} catch (Exception e) {
			System.out.println("Erreur : montant à débiter au delà du découvert autorisé");
		}
		System.out.println(compteAntoine);
		
		try {
			compteAntoine.débiter(999994444);
		} catch (Exception e) {
			System.out.println("Erreur : montant à débiter au delà du découvert autorisé");
		}
		System.out.println(compteAntoine);
		...
		banque.créerCompte("Bébert");
		banque.créerCompte("Ludivine");
		banque.créerCompte("Ludivine");
