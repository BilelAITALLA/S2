...
public class Compte {
	...
	private int decouvertMaxi;
	
	
	public Compte(int numéro, Client client, long solde, int decouvertMaxi) {
		this.numéro = numéro;
	...
	public void débiter(long montant) throws CompteException {
		if(this.solde-montant < -this.decouvertMaxi) {
	...
	public String toString() {
        ...
        return "Compte numéro : " + this.numéro 
